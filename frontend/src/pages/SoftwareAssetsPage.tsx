...
export function SoftwareAssetsPage() {
  ...
  const fetchAssets = useCallback(async () => {
    try {
      ...
      setError('Failed to load software assets. Please try again.');
    } finally {
      setIsLoading(false);
    }
  ...
  if (error) {
    return (
      <PageLayout title="Software Assets" description="Track software licenses and subscriptions" breadcrumbs={breadcrumbs} maxWidth="xl">
        <ErrorMessage
          title="Error Loading Software Assets"
          message={error}
          type="error"
          variant="inline"
  ...
  return (
    <PageLayout
      ...
      description="Track software licenses, subscriptions, and compliance status"
    ...
    >
      ...
      {!isLoading && assets.length === 0 ? (
        <EmptyState
          ...
          description={hasActiveFilters ? 'Try adjusting your filters.' : 'Create your first software asset to get started.'}
        ...
        <>
          <section aria-label="Software assets list">
