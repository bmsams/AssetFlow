...
exports.isValidAssetTag = isValidAssetTag;
exports.parseAssetTag = parseAssetTag;
exports.generateBarcodeId = generateBarcodeId;
exports.barcodeIdToAssetTag = barcodeIdToAssetTag;
 ...
 */
function generateAssetTag(assetType) {
 ...
 */
function generateBarcodeId(tag) {
 ...
 */
function barcodeIdToAssetTag(barcodeId) {
...
//# sourceMappingURL=asset-tag.js.map