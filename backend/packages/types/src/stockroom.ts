...
export interface Stockroom extends BaseEntity {
  ...
  // Additional DB columns (V006 migration)
...
/**
 * Request payload for creating a new stockroom
 */
...
/**
 * Request payload for updating an existing stockroom
 */
...
/**
 * Filters for listing stockrooms
 */
