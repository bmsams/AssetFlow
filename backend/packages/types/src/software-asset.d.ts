 ...
 * Reclamation status
 */
export type ReclamationStatus = 'IDENTIFIED' | 'PENDING_NOTIFICATION' | 'USER_NOTIFIED' | 'PENDING_APPROVAL' | 'APPROVED' | 'REJECTED' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED' | 'DEFERRED';
/**
