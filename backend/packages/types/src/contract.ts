...
export interface Vendor extends BaseEntity {
  ...
  // Additional DB columns (V005 migration)
  ...
  readonly secondaryContactEmail?: string;
...
export interface Contract extends BaseEntity {
  ...
  readonly documentStorageId?: UUID;
  readonly signedDate?: ISODateString;
  readonly effectiveDate?: ISODateString;
  readonly terminationDate?: ISODateString;
