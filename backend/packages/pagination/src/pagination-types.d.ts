 ...
 */
export declare const PAGINATION_ERROR_CODES: {
    readonly INVALID_PAGE: "INVALID_PAGE";
    readonly INVALID_LIMIT: "INVALID_LIMIT";
    readonly INVALID_CURSOR: "INVALID_CURSOR";
    readonly INVALID_SORT_FIELD: "INVALID_SORT_FIELD";
    readonly INVALID_SORT_DIRECTION: "INVALID_SORT_DIRECTION";
    readonly INVALID_FILTER_FIELD: "INVALID_FILTER_FIELD";
    readonly INVALID_FILTER_OPERATOR: "INVALID_FILTER_OPERATOR";
    readonly INVALID_FILTER_VALUE: "INVALID_FILTER_VALUE";
    readonly EXPIRED_CURSOR: "EXPIRED_CURSOR";
};
 ...
 */
export declare class PaginationParseError extends Error {
    readonly code: string;
    readonly statusCode: number;
    readonly errors: readonly PaginationError[];
    constructor(message: string, errors: readonly PaginationError[], code?: string);
}
