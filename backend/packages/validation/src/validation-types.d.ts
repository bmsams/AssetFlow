...
export declare const VALIDATION_ERROR_CODES: {
    ...
    readonly UNIQUE_ITEMS: "UNIQUE_ITEMS";
    readonly INVALID_ENUM: "INVALID_ENUM";
    readonly ADDITIONAL_PROPERTIES: "ADDITIONAL_PROPERTIES";
 ...
 */
export declare const SUPPORTED_FORMATS: readonly ["email", "uuid", "uri", "uri-reference", "date", "date-time", "time", "hostname", "ipv4", "ipv6", "regex"];
...
export declare class RequestValidationError extends Error {
    ...
    readonly errors: readonly ValidationErrorDetail[];
    constructor(message: string, errors: readonly ValidationErrorDetail[], code?: string);
}
